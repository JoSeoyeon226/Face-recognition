...
- Timestamp: `2022-05-16 07:00`
- Build ID: `3a7e9e47-3f09-4ccd-bf5a-bc2f8340addf`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3a7e9e47-3f09-4ccd-bf5a-bc2f8340addf.git
$ cd 3a7e9e47-3f09-4ccd-bf5a-bc2f8340addf
```
